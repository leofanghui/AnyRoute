...
export const CLI_TOOLS: Record<string, CliCatalogEntry> = {
  ...
  "claude-desktop": {
    ...
    color: "#D97757",
    description: "Claude Desktop 3P Gateway profile routes model requests to OmniRoute",
    ...
    acpSpawnable: false,
    baseUrlSupport: "full",
    settingsFile: "Claude-3p/configLibrary/00000000-0000-4000-8000-000000201280.json",
    defaultModels: [
      {
  ...
  "codex-desktop": {
    ...
    icon: "desktop_windows",
    color: "#10A37F",
    description: "Codex Desktop routes model requests through OmniRoute via ~/.codex config",
    docsUrl: "https://github.com/openai/codex",
    configType: "custom",
    category: "code",
    vendor: "OpenAI",
